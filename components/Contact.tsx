    ...
    <div className="grid lg:grid-cols-2 gap-16">
      <div className="space-y-8">
        <div className="space-y-4">
          <h2 className="text-3xl sm:text-4xl font-bold text-white tracking-tight">Let's build something <span className="text-blue-500">extraordinary</span>.</h2>
        ...
        <div className="space-y-6">
          {[
            ...
            { label: 'Phone', value: '+917995732336', icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z' },
      ...
      <div className="p-6 sm:p-10 bg-zinc-900/30 border border-zinc-900 rounded-[2.5rem] relative overflow-hidden">
        {/* Abstract shape */}
